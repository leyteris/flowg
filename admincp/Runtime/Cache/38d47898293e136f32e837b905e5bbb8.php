            ...
            <div id="main">
              <table id="listtable" width="100%" border="1" align="center" cellpadding="0"  cellspacing="0">
                <tr>
                  ...
                  <th width="16%" scope="col">权限</th>
                  <th width="19%" scope="col">创建时间</th>
                  <th width="37%" scope="col">操作</th>
                </tr>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
                  ...
                  <td><a href="<?php echo U('admin/setPass');?>?id=<?php echo ($vo["id"]); ?>">修改密码</a>/<a href="<?php echo U('admin/setRole');?>?id=<?php echo ($vo["id"]); ?>">设置权限</a>/<a href="<?php echo U('admin/delete');?>?id=<?php echo ($vo["id"]); ?>">删除</a></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
              </table>
              <div class="left"><a href="<?php echo U('admin/add');?>">增加用户</a></div>
