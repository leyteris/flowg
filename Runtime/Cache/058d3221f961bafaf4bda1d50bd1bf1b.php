    ...
    <div class="blogbody">
        ...
        <div class="left-nav">
            <div class="msglistbox">
                <ul id="msglistmenu">
                	<li><a href="<?php echo U('hall/index');?>">热门人物</a></li>
                	<li><a href="<?php echo U('hall/hottopic');?>">热门微博</a></li>
                	<li><a href="<?php echo U('hall/hottag');?>">热门话题</a></li>
                	<li><a href="<?php echo U('hall/topickong');?>">纯微博控</a></li>
                </ul>
                <ul id="followlist">
