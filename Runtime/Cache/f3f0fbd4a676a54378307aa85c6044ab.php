...
#seaF{
    ...
    <div class="blogbody">
        ...
        <div class="left-nav">
	        ...
	        <div id="search-user">
	        	<?php if(empty($ulist)): ?>无相关搜索用户 <?php else: ?>
	        	<ul>
	                <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li>
        ...
        <div class="msglistbox">
                <ul id="msglistmenu">
                	<li><a href="<?php echo U('search/index');?>">搜索微博</a></li>
                </ul>
                <?php if(empty($tlist)): ?>无相关搜索微博 <?php else: ?>
        		<ul id="talklist">
                	<?php if(is_array($tlist)): $i = 0; $__LIST__ = $tlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="listbody"  id="<?php echo ($vo["id"]); ?>">
                    	<div class="userpic">
                        	<a href="<?php echo ($webpath); ?><?php echo ($vo["homepage"]); ?>"><img alt="头像" src="<?php echo getUserAvatar($vo['avatar'],120);?>" alt="<?php echo ($vo["nickname"]); ?>"/></a>
                        </div>
                        <div class="listbodyright">
							...
							<div class="listfooter">
                            	<div class="listfooterl">
                                    <span class="listuptime"><?php echo ($vo["time"]); ?></span>
                                ...
                                <div class="listfooterr">
                                    ...
                                    <?php if($vo["id"] == $userinfo['id']): ?><span><a href="<?php echo U('ajax/ajaxDeleteMyTopic');?>?tid=<?php echo ($vo["id"]); ?>" class="deltpbtn">删除</a></span>
                                    <?php else: ?>
