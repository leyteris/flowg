    ...
    <div class="blogbody">
        ...
        <div class="left-nav">
            ...
            <div class="msglistbox">
                <ul id="msglistmenu">
                	<li><a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>">全部微博</a></li>
                </ul>
                <ul id="talklist">
                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="listbody"  id="<?php echo ($vo["id"]); ?>">
                    	<div class="userpic">
                        	<a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>"><img alt="头像" src="<?php echo getUserAvatar($rs['avatar'],50);?>" alt="<?php echo ($rs["nickname"]); ?>"/></a>
                        </div>
                        <div class="listbodyright">
                            <a class="username" href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>">                            	
                            ...
                            <div class="listfooter">
                                ...
                                <div class="listfooterr">
                                    ...
                                    <?php if($rs["id"] == $userinfo['id']): ?><span><a href="<?php echo U('ajax/ajaxDeleteMyTopic');?>?tid=<?php echo ($vo["id"]); ?>" class="deltpbtn">删除</a></span>
                                    <?php else: ?>
