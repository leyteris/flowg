...
<div class="wrapper">
    ...
    <div class="blogbody">
    	<?php if($detailflag == 1): ?><div class="right-nav">
        	<div class="right-nav-bg"></div>
			    		<div class="userinfo">
            	<ul class="userdetail">	
                	<li class="usertitle"><?php echo ($rs["nickname"]); ?>的资料</li>
                    <li>
                    	<?php if($rs["sex"] == '0'): ?>女
						<?php else: ?> 
							男<?php endif; ?> 
					</li>
                    <li>地址:<?php echo (($rs["address"])?($rs["address"]):'太阳系 火星'); ?></li>
                    <li>个人主页：<?php echo (($rs["personalpage"])?($rs["personalpage"]):'无'); ?></li>
                </ul>    
        	</div>
        ...
        <div class="left-nav">
        	<?php if($detailflag == 1): ?><div id="detailbox">
				<a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>" class="userbigpic"><img src="<?php echo getUserAvatar($rs['avatar'],120);?>" alt="<?php echo ($rs["nickname"]); ?>"/></a>
                <div id="detailright">
                	<h1>
                    	<span class="userheader"><?php echo ($rs["nickname"]); ?></span>
                        <span>(@<?php echo ($rs["homepage"]); ?>)</span><br />
                        <a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>"><?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?></a>
                    </h1>
                    <div id="followdetail">
                    	<a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>">发布微博<em><?php echo (($topiccount)?($topiccount):"0"); ?></em>条</a>
                        <span>|</span>
                        <a href="<?php echo U('follow/index');?>?uid=<?php echo ($rs["id"]); ?>">关注<em><?php echo (($follows)?($follows):"0"); ?></em>人</a>
                        <span>|</span>
                        <a href="<?php echo U('follow/fans');?>?uid=<?php echo ($rs["id"]); ?>">粉丝<em><?php echo (($fans)?($fans):"0"); ?></em>人</a>
                    </div>
					<div>
						<a href="<?php echo U('ajax/ajaxFollow');?>?objuid=<?php echo ($rs["id"]); ?>" class="followta">关注TA</a>
					</div>
                </div>
            </div><?php endif; ?>
            <div class="msglistbox">
                <ul id="msglistmenu">
                	<?php if($detailflag == 1): ?><li><a href="<?php echo U('follow/index');?>?uid=<?php echo ($rs["id"]); ?>">TA的关注</a></li>
						<li><a href="<?php echo U('follow/fans');?>?uid=<?php echo ($rs["id"]); ?>">TA的粉丝</a></li>
					<?php else: ?>
						<li><a href="<?php echo U('follow/index');?>">我的关注</a></li>
						<li><a href="<?php echo U('follow/fans');?>">我的粉丝</a></li><?php endif; ?>  
                </ul>
                <ul id="followlist">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="listbody">
                    	<div class="userpic">
                        	<a href="<?php echo ($webpath); ?><?php echo ($vo["homepage"]); ?>"><img alt="<?php echo ($vo["nickname"]); ?>" src="<?php echo getUserAvatar($vo['avatar'],50);?>" /></a>
                        </div>
                        <div class="listbodyright">
                            <a class="username" href="<?php echo ($webpath); ?><?php echo ($vo["homepage"]); ?>"><?php echo ($vo["nickname"]); ?></a>
                            <div class="clear">最近发布微博于   <?php echo ($vo["lasttopic"]["create_time"]); ?> 来自<?php echo ($vo["lasttopic"]["from"]); ?></div>
							<div class="usermsg"><?php echo ($vo["lasttopic"]["content"]); ?></div>
							<div class="detailbody">
								<span><a href="<?php echo U('follow/index');?>?uid=<?php echo ($vo["id"]); ?>">关注<em><?php echo (($vo["thisfollowerfollows"])?($vo["thisfollowerfollows"]):"0"); ?></em>人</a></span>
                            	<span><a href="<?php echo U('follow/fans');?>?uid=<?php echo ($vo["id"]); ?>">粉丝<em><?php echo (($vo["thisfollowerfans"])?($vo["thisfollowerfans"]):"0"); ?></em>人</a></span>
                            </div>
							<div><a class="delfavoritebtn" href="<?php echo U('ajax/ajaxDeleteFollow');?>?objuid=<?php echo ($vo["id"]); ?>">取消关注</a></div>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="pages">
