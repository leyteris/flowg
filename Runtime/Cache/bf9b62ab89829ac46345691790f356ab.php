...
<link rel="stylesheet" type="text/css" href="__TMPL__Lab/css/wall.css"/>
	<script language="javascript" type="text/javascript" src="__TMPL__Lab/js/wall.js"></script>
	<div id="fbody">
		<div id="elelist">
		<?php if(is_array($topicList)): $i = 0; $__LIST__ = $topicList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="ele">
				<div class="ele-left">
				    <a href="<?php echo ($webpath); ?><?php echo ($vo["homepage"]); ?>"><img src="<?php echo getUserAvatar($vo['avatar'],50);?>" alt="<?php echo ($vo["nickname"]); ?>" style="border:1px solid #ccc;padding:1px;" /></a>
				</div>
				<div class="ele-right">
					<a class="closeBox"  title="关闭">关闭</a>
				    <div class="ele-content"><a href="<?php echo ($webpath); ?><?php echo ($rs["homepage"]); ?>"><?php echo ($vo["nickname"]); ?></a> ： <?php echo ($vo["content"]); ?></div>
					<div class="clear">发布于<?php echo ($vo["time"]); ?> ,来自<?php echo ($vo["from"]); ?></div>
				</div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
		<!-- <div id="fsform">
			<form action="#">
				<textarea rows="20" cols="50" id="fstext"></textarea>
				<input id="fssubmit"type="button" value="submit" />
			</form>
		</div> -->
		</div></div>
<div class="footer">
