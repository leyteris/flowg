...
<div class="wrapper">
    ...
    <div class="blogbody">
        ...
        <div class="left-nav">
						<div id="<?php echo ($trs["id"]); ?>" class="topicbox listbody">
				<div class="userpic">
                	<a href="<?php echo ($webpath); ?><?php echo ($urs["homepage"]); ?>"><img alt="<?php echo ($urs["nickname"]); ?>" src="<?php echo getUserAvatar($urs['avatar'],50);?>" /></a>
                </div>
                <div class="listbodyright">
                	<a class="username" href="<?php echo ($webpath); ?><?php echo ($urs["homepage"]); ?>"><?php echo ($urs["nickname"]); ?>:</a>
                    <p class="usermsg">
                    	<?php echo ($trs["content"]); ?>
                    </p>
                    <?php if($trs["imgid"] != 0): ?><div class="useruppic">
	                            	<a class="artZoom" href="<?php echo ($trs["topicpic"]["url"]); ?>" rel="<?php echo ($trs["topicpic"]["url"]); ?>">
	                            		<img src="<?php echo ($trs["topicpic"]["thumb_url"]); ?>" />
									</a>
								</div><?php endif; ?>
                    <div class="listfooter">
                    <div class="listfooterl">
                    <span class="listuptime"><?php echo ($trs["create_time"]); ?></span>
                    <span class="listupclt">来自<a href="#"><?php echo ($trs["from"]); ?></a></span>
                    </div>
                    <div class="listfooterr">
                     ...
                     <span><a href="javascript:void(0)" class="attabtn" onmouseout="F.addAttaTxt('对 @<?php echo ($urs["homepage"]); ?> 说：')">@TA</a></span>
            ...
            <div class="msglistbox">
                <ul id="msglistmenu">
                	<li><a href="#">全部(<?php echo ($count); ?>)</a></li>
                	<li><a href="#">转发(<?php echo ($transcount); ?>)</a></li>
                	<li><a href="#">评论(<?php echo ($commcount); ?>)</a></li>
                </ul>
                <ul id="talklist">
                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="listbody"  id="<?php echo ($vo["id"]); ?>">
                        ...
                        <div class="listbodyright">
                            <a class="username" href="<?php echo ($webpath); ?><?php echo ($vo["homepage"]); ?>">                            	
                            	...
                            	<?php if($vo["type"] == 'transmit'): ?><em class="zhuantext">转发</em>
                            	<?php else: ?>
                            		<em class="zhuantext">点评</em><?php endif; ?>
                            	:
                            </a>
