...
// +----------------------------------------------------------------------
// $Id: Image.class.php,v 1.2 2010/12/19 15:31:59 leyteris Exp $
 ...
 * @subpackage  Util
 * @author    liu21st <liu21st@gmail.com>
 * @version   $Id: Image.class.php,v 1.2 2010/12/19 15:31:59 leyteris Exp $
  +------------------------------------------------------------------------------
 */
class Image extends Think {//类定义开始
     ...
     * @return string
      +----------------------------------------------------------
     */
    static function buildImageVerify($length=5, $mode=1, $type='png', $width=60, $height=35, $verifyName='verify') {
